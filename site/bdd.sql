...
--
-- Hôte : localhost
-- Généré le :  mar. 03 juil. 2018 à 20:16
...
(5, 'lasagnes', 14.99, 'plat', 'lasagne sans oeufs, coulis de tomates,soja,huile d\'olive,oignon,ail,herbe de provence,origan,muscade,curcuma,sel et poivre,bouillon de légume bio, lait de soja nature,maizena', 'gluten'),
(6, 'salade', 6.99, 'entree', 'courge, chou, citron,huile d\'olive,vinaigre de pomme', ''),
(7, 'samoussas', 6.99, 'entree', 'feuilles de bricks, pommes de terre, petits pois, carottes, curry, curcuma,cumin,soja,sel, poivre', 'soja'),
...
(15, 'parmentier', 12.99, 'plat', 'pommes de terre, protéines de soja, lait de soja, huile d\'olive, coulis de tomate, chapelure, tamari, curcuma,ail, oignon, herbes de provence, sel et poivre', 'soja, sésame'),
